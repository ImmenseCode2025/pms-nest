DROP PROCEDURE IF EXISTS sp_get_parking_tickets_pdf;

DELIMITER $$

CREATE PROCEDURE sp_get_parking_tickets_pdf(
...
BEGIN
    ...
    -- =========================================================================
    -- Complete Filtered Rows for PDF Report (Max 20,000 for PDF generation)
    -- =========================================================================
    SELECT * FROM (
        (
            -- System Tokens
